...
export function testKanji(value: string): boolean {
  return TEST_KANJI.test(value);
}

export function testNumeric(value: string): boolean {
  return TEST_NUMERIC.test(value);
}

export function testAlphanumeric(value: string): boolean {
  return TEST_ALPHANUMERIC.test(value);
}
