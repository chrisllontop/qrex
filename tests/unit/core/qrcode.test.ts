...
import type { QRexOptions,QRData, QrContent,ErrorCorrectionLevelBit,MaskPatternType,Segment, ErrorCorrectionLevelString, DataMode } from "../../../src/types/qrex.type"
...
describe("QRCode Interface", () => {
  ...
  it("Should throw if no data is provided", () => {
    expect(() => QRex.create(undefined as unknown as QrContent)).toThrow(
      "No input text"
    );
  });
